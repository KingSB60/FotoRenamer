...
namespace FotoRenamer.ViewModel.Dialigs;
...
public class DialogViewModelBase : ObservableRecipient
{
    ...
    public DialogViewModelBase(DialogViewModelBase copyThis)
    {
        ...
        if (copyThis._mProblems != null) _mProblems = new ObservableCollection<Msg>(copyThis._mProblems);
    ...
    public bool? WindowCloseResult
    {
        ...
        private set => SetProperty(ref _mDialogCloseResult, value);
    }
    ...
    public bool IsReadyToClose
    {
        ...
        set => SetProperty(ref _mIsReadyToClose, value);
    }
    ...
    /// </summary>
    public ICommand CancelCommand => _mCancelCommand ?? (_mCancelCommand = new RelayCommand(() => { OnRequestClose(false); }));

    /// <summary>
    /// Execute the OK command (occurs typically when a user clicks OK in the dialog)
    /// </summary>
    public ICommand OkCommand => _mOkCommand ?? (_mOkCommand = new RelayCommand(() =>
    {
    ...
    /// <summary>
    /// this string can be shown as title of the dialog box
    /// </summary>
    ...
    {
        ProblemCaption = Strings.CAPTION_DialogInputProblem;
